...
const FIELD_TO_TAB: Record<string, FieldInfo> = {
  description: {
    field: "description",
    label: "Description",
    tab: "trip-page#description",
  },
  what_to_bring: {
    field: "what_to_bring",
    label: "What to Bring",
    tab: "trip-page#packing-list",
  },
  picture_path: {
    field: "picture_path",
    label: "Trip Picture",
    tab: "trip-page#picture",
  },
  activity: { field: "activity", label: "Activity", tab: "trip-page#activity" },
  difficulty: {
    field: "difficulty",
    label: "Difficulty",
    tab: "trip-page#difficulty",
  },
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="max-w-lg md:min-w-[600px]!">
        ...
        {hasMissingFields ? (
          ...
          <div className="space-y-6 max-h-[60vh] overflow-scroll mt-4">
            {/* Trip Info */}

            <div className="flex items-start gap-4">
              {trip.picture_path && (
                <div className="relative rounded-md overflow-hidden aspect-video w-48">
                  <Image
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center gap-1 text-sm">
                  <div className="flex items-center gap-1">
                    ...
                    <span>{trip.participant_spots} participants</span>
                  </div>
                  {trip.driver_spots > 0 && (
                    <span>
                      • {trip.driver_spots} driver
                      {trip.driver_spots > 1 ? "s" : ""}
                    </span>
                  )}
                  <span>
                    • {trip.trip_guides?.length || 0}{" "}
                    {trip.trip_guides?.length === 1 ? "guide" : "guides"}
                  </span>
                </div>
              </div>
            </div>
