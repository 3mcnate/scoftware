...
begin
	...
	if new.raw_user_meta_data->>'phone' is null then
		...
		select new.raw_user_meta_data->>'phone' into user_phone;
	end if;
...
CREATE OR REPLACE FUNCTION "public"."is_trip_guide"("u1" "uuid", "u2" "uuid") RETURNS boolean
    LANGUAGE "plpgsql"
    SET "search_path" TO ''
    AS $$
declare
...
ALTER FUNCTION "public"."is_trip_guide"("u1" "uuid", "u2" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."trip_has_tickets"("t_id" "uuid") RETURNS boolean
    LANGUAGE "plpgsql"
    SET "search_path" TO ''
    AS $$
begin
...
ALTER FUNCTION "public"."trip_has_tickets"("t_id" "uuid") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."tickets" (
    ...
    "driver_waiver_signed_at" timestamp with time zone,
...
CREATE TABLE IF NOT EXISTS "public"."trips" (
    ...
    "total_miles" integer,
    "trail" "text",
    CONSTRAINT "ends_after_start" CHECK (("start_date" < "end_date")),
    CONSTRAINT "trips_breakfasts_check" CHECK (("breakfasts" >= 0)),
    CONSTRAINT "trips_car_mpgs_check" CHECK (((0)::numeric <= ALL ("car_mpgs"))),
    CONSTRAINT "trips_dinners_check" CHECK (("dinners" >= 0)),
    CONSTRAINT "trips_driver_spots_check" CHECK (("driver_spots" >= 0)),
    CONSTRAINT "trips_lunches_check" CHECK (("lunches" >= 0)),
    CONSTRAINT "trips_participant_spots_check" CHECK (("participant_spots" >= 0)),
    CONSTRAINT "trips_snacks_check" CHECK (("snacks" >= 0)),
    CONSTRAINT "trips_total_miles_check" CHECK (("total_miles" >= 0))
);
...
CREATE TABLE IF NOT EXISTS "public"."waitlist_signups" (
    ...
    "sign_up_success" boolean DEFAULT false NOT NULL
);
...
ALTER TABLE ONLY "public"."tickets"
    ADD CONSTRAINT "tickets_trip_id_fkey1" FOREIGN KEY ("trip_id") REFERENCES "public"."trips"("id");
...
CREATE POLICY "Allow guides to select trip guides" ON "public"."trip_guides" FOR SELECT TO "authenticated" USING ("public"."authorize"('guide'::"public"."user_role"));



CREATE POLICY "Allow guides to view roles" ON "public"."roles" FOR SELECT TO "authenticated" USING ("public"."authorize"('guide'::"public"."user_role"));



CREATE POLICY "Allow guides, user to select own profile" ON "public"."profiles" FOR SELECT TO "authenticated" USING ((("id" = ( SELECT "auth"."uid"() AS "uid")) OR "public"."authorize"('guide'::"public"."user_role")));
...
CREATE POLICY "Allow trip deletion" ON "public"."trips" FOR DELETE TO "authenticated" USING ((("public"."is_trip_guide"("id", ( SELECT "auth"."uid"() AS "uid")) OR "public"."authorize"('admin'::"public"."user_role")) AND (NOT "public"."trip_has_tickets"("id"))));



CREATE POLICY "Allow users to update own profile" ON "public"."profiles" FOR UPDATE TO "authenticated" USING (("id" = ( SELECT "auth"."uid"() AS "uid"))) WITH CHECK (("id" = ( SELECT "auth"."uid"() AS "uid")));



CREATE POLICY "Allow users to view their memberships" ON "public"."memberships" FOR SELECT TO "authenticated" USING (("user_id" = ( SELECT "auth"."uid"() AS "uid")));
...
CREATE POLICY "Guides can select trips" ON "public"."trips" FOR SELECT TO "authenticated" USING ("public"."authorize"('guide'::"public"."user_role"));



CREATE POLICY "Guides can view waitlist signups" ON "public"."waitlist_signups" FOR SELECT TO "authenticated" USING ("public"."authorize"('guide'::"public"."user_role"));



CREATE POLICY "Guides, participants can select their own information" ON "public"."participant_info" FOR SELECT TO "authenticated" USING ((("user_id" = ( SELECT "auth"."uid"() AS "uid")) OR "public"."authorize"('guide'::"public"."user_role")));



CREATE POLICY "Guides, participants can select their own tickets" ON "public"."tickets" FOR SELECT TO "authenticated" USING ((("user_id" = ( SELECT "auth"."uid"() AS "uid")) OR "public"."authorize"('guide'::"public"."user_role")));
...
GRANT ALL ON FUNCTION "public"."is_trip_guide"("u1" "uuid", "u2" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."is_trip_guide"("u1" "uuid", "u2" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."is_trip_guide"("u1" "uuid", "u2" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."trip_has_tickets"("t_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."trip_has_tickets"("t_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."trip_has_tickets"("t_id" "uuid") TO "service_role";
...
CREATE POLICY "Give guides, users access to own folder ignnv3_0" ON "storage"."objects" FOR SELECT TO "authenticated" USING ((("bucket_id" = 'waivers'::"text") AND ((( SELECT ("auth"."uid"())::"text" AS "uid") = ("storage"."foldername"("name"))[1]) OR "public"."authorize"('guide'::"public"."user_role"))));



CREATE POLICY "Give users access to own folder 1oj01fe_0" ON "storage"."objects" FOR SELECT USING ((("bucket_id" = 'avatars'::"text") AND (( SELECT ("auth"."uid"())::"text" AS "uid") = ("storage"."foldername"("name"))[1])));



CREATE POLICY "Give users access to own folder 1oj01fe_1" ON "storage"."objects" FOR INSERT WITH CHECK ((("bucket_id" = 'avatars'::"text") AND (( SELECT ("auth"."uid"())::"text" AS "uid") = ("storage"."foldername"("name"))[1])));



CREATE POLICY "Give users access to own folder 1oj01fe_2" ON "storage"."objects" FOR UPDATE USING ((("bucket_id" = 'avatars'::"text") AND (( SELECT ("auth"."uid"())::"text" AS "uid") = ("storage"."foldername"("name"))[1])));



CREATE POLICY "Give users access to own folder 1oj01fe_3" ON "storage"."objects" FOR DELETE USING ((("bucket_id" = 'avatars'::"text") AND (( SELECT ("auth"."uid"())::"text" AS "uid") = ("storage"."foldername"("name"))[1])));
