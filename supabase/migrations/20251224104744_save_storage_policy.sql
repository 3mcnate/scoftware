drop policy "Give users access to own avatar 1oj01fe_0" on "storage"."objects";

drop policy "Give users access to own avatar 1oj01fe_1" on "storage"."objects";

drop policy "Give users access to own avatar 1oj01fe_2" on "storage"."objects";

drop policy "Give users access to own avatar 1oj01fe_3" on "storage"."objects";
